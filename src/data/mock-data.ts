...
export const MOCK_MEETINGS: Meeting[] = [
  ...
  { id: "meet_7", title: "Discovery Call — TechNova (completed)", type: "discovery", date: daysAgo(7), duration: 45, attendees: ["Maria Silva", "Ana Beatriz Costa"], ownerId: "usr_ana", relatedType: "lead", relatedId: "lead_1", relatedName: "Maria Silva — TechNova", status: "completed", notes: "Identified key pain: 5+ tool integration overhead. Budget: R$400-500K. Timeline: Q1 decision.", location: "Google Meet" },
...
export const MOCK_ACTIVITIES: Activity[] = [
  ...
  { id: "act_5", type: "note", summary: "Budget range confirmed: R$400-500K. Decision timeline: Q1.", userId: "usr_ana", userName: "Ana Beatriz Costa", relatedType: "lead", relatedId: "lead_1", relatedName: "Maria Silva", createdAt: daysAgo(7), source: "manual", confidence: 90, tags: ["budget", "timeline"] },
...
export const MOCK_INSIGHTS: Insight[] = [
  ...
  { id: "ins_5", title: "Forecast inconsistency detected", description: "Lucas Martins has R$500K in committed forecast but only 2 active interactions this week. Historical data shows committed deals require 5+ weekly touchpoints.", impact: "high", action: "Review forecast assumptions and increase activity on committed deals.", confidence: 78, source: "Forecast vs. activity correlation", relatedType: "user", relatedId: "usr_lucas", relatedName: "Lucas Martins", category: "forecast", createdAt: daysAgo(0) },
  ...
  { id: "ins_7", title: "High-value pipeline bottleneck at Proposal stage", description: "R$645K in pipeline value is stuck at Proposal stage. 2 opportunities have been there for 8+ days.", impact: "high", action: "Review proposals and accelerate follow-ups. Consider pricing adjustments.", confidence: 87, source: "Pipeline flow analysis", relatedType: "pipeline", relatedId: "stage_prop", relatedName: "Proposal Stage", category: "pipeline", createdAt: daysAgo(0) },
...
export const MOCK_AUDIT_LOGS: AuditLog[] = [
  ...
  { id: "audit_4", userId: "usr_camila", userName: "Camila Souza", action: "opportunity.closed_won", object: "Opportunity", objectId: "opp_6", objectName: "Revenue Operations — GreenEnergy", details: "Deal closed at R$380,000. Contract signed.", source: "web_app", createdAt: daysAgo(5) },
