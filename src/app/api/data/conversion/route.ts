...
export async function GET(request: NextRequest) {
  try {
    ...
    const stages = ["PROSPECTING", "INITIAL_CONTACT", "PROPERTY_TOUR", "LOI_SUBMITTED", "LOI_NEGOTIATION", "UNDER_CONTRACT", "DUE_DILIGENCE", "FINANCING", "CLOSING", "CLOSED_WON", "CLOSED_LOST"];
